...
//
// Fechas/sedes: cruzadas entre dos fuentes públicas (estructura de grupos
// coincide en ambas), pero las horas exactas tienen cierto margen de error —
// no es crítico porque ninguna lógica depende de la hora exacta del cruce,
// solo del día (agrupación en la porra). Revisar contra el calendario
// oficial si hace falta más precisión más adelante.
...
export const KNOCKOUT_2026_MATCHES: KnockoutMatchData[] = [
  ...
  m(74, "R32", [2026, 6, 29, 20, 30], "1º Grupo E", "group:E:1", "3º (A/B/C/D/F)", "thirds:A,B,C,D,F", "Boston"),
  m(75, "R32", [2026, 6, 30, 1, 0], "1º Grupo F", "group:F:1", "2º Grupo C", "group:C:2", "Monterrey"),
  m(76, "R32", [2026, 6, 29, 17, 0], "1º Grupo C", "group:C:1", "2º Grupo F", "group:F:2", "Houston"),
  m(77, "R32", [2026, 6, 30, 21, 0], "1º Grupo I", "group:I:1", "3º (C/D/F/G/H)", "thirds:C,D,F,G,H", "Nueva York/Nueva Jersey"),
  m(78, "R32", [2026, 6, 30, 17, 0], "2º Grupo E", "group:E:2", "2º Grupo I", "group:I:2", "Dallas"),
  ...
  m(81, "R32", [2026, 7, 2, 0, 0], "1º Grupo D", "group:D:1", "3º (B/E/F/I/J)", "thirds:B,E,F,I,J", "Bahía de San Francisco"),
  m(82, "R32", [2026, 7, 1, 20, 0], "1º Grupo G", "group:G:1", "3º (A/E/H/I/J)", "thirds:A,E,H,I,J", "Seattle"),
  m(83, "R32", [2026, 7, 2, 23, 0], "2º Grupo K", "group:K:2", "2º Grupo L", "group:L:2", "Toronto"),
  m(84, "R32", [2026, 7, 2, 19, 0], "1º Grupo H", "group:H:1", "2º Grupo J", "group:J:2", "Los Ángeles"),
  m(85, "R32", [2026, 7, 3, 3, 0], "1º Grupo B", "group:B:1", "3º (E/F/G/I/J)", "thirds:E,F,G,I,J", "Vancouver"),
  m(86, "R32", [2026, 7, 3, 22, 0], "1º Grupo J", "group:J:1", "2º Grupo H", "group:H:2", "Miami"),
  m(87, "R32", [2026, 7, 4, 1, 30], "1º Grupo K", "group:K:1", "3º (D/E/I/J/L)", "thirds:D,E,I,J,L", "Kansas City"),
  m(88, "R32", [2026, 7, 3, 18, 0], "2º Grupo D", "group:D:2", "2º Grupo G", "group:G:2", "Dallas"),

  // ─── Octavos (R16) ────────────────────────────────────────────────────
  m(89, "R16", [2026, 7, 4, 21, 0], "Ganador Partido 74", "match:74:W", "Ganador Partido 77", "match:77:W", "Filadelfia"),
  m(90, "R16", [2026, 7, 4, 17, 0], "Ganador Partido 73", "match:73:W", "Ganador Partido 75", "match:75:W", "Houston"),
