...
export default function WhatsNewModal() {
  ...
  const changes = [
    {
      icon: "📱",
      title: t.whatsNew.pwaTitle,
      desc: t.whatsNew.pwaDesc,
    },
    {
      icon: "⚽",
      title: t.whatsNew.knockoutTitle,
      desc: t.whatsNew.knockoutDesc,
    },
    {
      icon: "🛡",
      title: t.whatsNew.squadTitle,
      desc: t.whatsNew.squadDesc,
    },
  ];
